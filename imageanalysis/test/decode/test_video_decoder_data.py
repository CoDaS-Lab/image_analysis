...
def download_data():
    if not os.path.exists(data_dir + '/test_video.mp4'):
        print(data_dir + '/test_video.mp4')
        wget.download('https://s3.amazonaws.com/testcodas/test_video.mp4',
                      data_dir)
    if not os.path.exists(data_dir + '/test_video_data.npy'):
        print(data_dir + '/test_video.mp4')
        wget.download('https://s3.amazonaws.com/testcodas/test_video_data.npy',
                      data_dir)
